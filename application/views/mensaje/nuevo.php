   ...
   <form method="post" action="<?= site_url('admin/mensaje/nuevo');?>">
      <div class="col-md-6">
            ...
            <div class="form-group">
               ...
               <textarea rows="4" class="form-control" name="mensaje"></textarea>
            </div>
      ...
      <div class="col-md-6">
         <h3>Seleccion los destinatarios</h3>
            <div class="form-group well">
               ...
               <ul>
                  <li class="checkbox"><input type="checkbox" name="ing_informatica" value="">Ingenieria en informatica
                     <ul>
                        <li class="checkbox"><input type="checkbox" name="semestre" value="">Semestre II
                           <ul>
               ...
               <ul>
                  <li class="checkbox"><input type="checkbox" name="ing_informatica" value="">Analista programador
                     <ul>
                        <li class="checkbox"><input type="checkbox" name="semestre" value="">Semestre I</li>
                        <li class="checkbox"><input type="checkbox" name="semestre" value="">Semestre II</li>
                        <li class="checkbox"><input type="checkbox" name="semestre" value="">Semestre III
                           <ul>
                              <li class="checkbox"><input type="checkbox" name="semestre" value="">Alejandro Vargas</li>
                              <li class="checkbox"><input type="checkbox" name="semestre" value="">Fabian Vasquez</li>
                              <li class="checkbox"><input type="checkbox" name="semestre" value="">Andres Otero</li>
